  ...
  return (
    <section id="cta" className="pb-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          <div className="rounded-[2.45rem] bg-slate-100 dark:bg-slate-950/80 px-8 py-14 text-center shadow-2xl backdrop-blur">
            <div className="mx-auto max-w-3xl space-y-6">
              <span className="rounded-full border border-slate-300 dark:border-white/20 px-4 py-1 text-xs uppercase tracking-[0.4em] text-slate-600 dark:text-white/70">
                Join Mentor Bridge
              </span>
